...
class Expectra_2D:
    ...
    def __init__(self,object,center_cut = None,size_cut=None,distances=None,verbose=False,header=None,**kwargs):
        ...
        self.cut_data = Expectra_2D.cut_2d_image(self.original_data,center=self.center_cut,size=size_cut,verbose=True)
        self.cut_error = Expectra_2D.cut_2d_image(self.original_error,center=self.center_cut,size=size_cut,verbose=False)
        self.cut_quality = Expectra_2D.cut_2d_image(self.original_quality,center=self.center_cut,size=size_cut,verbose=False)
